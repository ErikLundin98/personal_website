 ...
 */
 ...
 var AsciiMorph = (function() {
  ...
  AsciiMorph(element, {x: 2,y: 10});
  

var current_number = 0;
function getFact() {

    $.get('http://numbersapi.com/' + current_number + '/trivia?notfound=floor&fragment', function(data) {
        data = [current_number + ":", data];
        console.log(data)
...
AsciiMorph.render(["Here is an infinite list", "of facts about numbers"]);
